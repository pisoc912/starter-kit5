              ...
              <Grid container justifyContent='center' alignItems='center' >
                <Grid item xs={5} >
                  <ListItem direction="row" alignItems="flex-start" justifyContent="center">
                    <ListItemAvatar>
                      <Avatar alt={candidate.name} src="/images/avatar/1.png" />
                    </ListItemAvatar>
                    <ListItemText
                      ...
                      secondary={
                        <React.Fragment>
                          <Typography
                            ...
                            color="text.primary"
                          >
                            {String(candidate.createdAt).substring(0, 10)} {candidate.currentTitle}
                          </Typography>
                        </React.Fragment>
                      }
                    />
                ...
                <Grid item xs={1.5} sx={{ alignItems: 'center', justifyItems: 'center' }}>
                  <IconButton
                    aria-label="mark"
                    key={index}
                    color={marked === candidate ? 'error' : color}
                    onClick={() => {
                      if (marked === candidate) {
                        setMarked(null);
                        setColor('default');
              ...
              >
                <div>
                  {popupContent.map(user => {
                    return (
                      <Grid container xs={12} key={user.id} >
                        <Grid container xs={4} spacing={2} direction="column" alignItems="center">
